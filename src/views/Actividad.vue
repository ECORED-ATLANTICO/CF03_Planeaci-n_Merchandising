    ...
    cuestionario: {
      ...
      preguntas: [
        ...
        },
        {
          id: 4,
          texto:
            'Los hitos y entregables permiten medir el avance y cumplimiento de un plan.',
          imagen: require('@/assets/actividad/imagen1.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        {
          id: 5,
          texto: 'Un hito es una meta financiera del proyecto.',
        ...
        },
        {
          id: 6,
          texto:
            'Los entregables deben estar claramente definidos para asegurar el seguimiento del plan.',
          imagen: require('@/assets/actividad/imagen2.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 8,
          texto:
            'No es necesario perfilar los cargos si se cuenta con suficiente personal.',
          imagen: require('@/assets/actividad/imagen2.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 9,
          texto:
            'Una de las responsabilidades del talento humano es garantizar la correcta aplicación del plan en el punto de venta.',
        ...
        },
        {
          id: 11,
          texto:
            'Un cronograma ayuda a organizar las actividades y distribuir tiempos de ejecución.',
          imagen: require('@/assets/actividad/imagen3.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 12,
          texto:
            'Los pasos para elaborar un cronograma incluyen la identificación de actividades, secuencia y tiempos.',
          imagen: require('@/assets/actividad/imagen3.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 13,
          texto:
            'Los indicadores permiten evaluar el impacto visual del diseño en la tienda únicamente.',
        ...
        },
        {
          id: 14,
          texto:
            'Los indicadores deben ser definidos con base en los objetivos del plan.',
          imagen: require('@/assets/actividad/imagen4.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        {
          id: 15,
          texto: 'Un buen indicador es claro, medible y pertinente.',
          imagen: require('@/assets/actividad/imagen4.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 17,
          texto:
            'El presupuesto debe contemplar todos los recursos financieros necesarios para implementar el plan.',
          imagen: require('@/assets/actividad/imagen4.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 18,
          texto:
            'Una técnica para definir presupuesto es la estimación por categorías de gasto.',
          imagen: require('@/assets/actividad/imagen4.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        {
          id: 20,
          texto: 'Los entregables no requieren evidencias o productos finales.',
          imagen: require('@/assets/actividad/imagen4.png'),
          barajarRespuestas: true,
          opciones: [
            {
