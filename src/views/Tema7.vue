...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    #t_7_2.titulo-segundo.color-secundario(data-aos="flip-up")
      h2 7.2 Hitos y entregables
    ...
    #t_7_3.titulo-segundo.color-secundario(data-aos="flip-up")
      h2 7.3 Talento humano involucrado
    
    p.mb-5 A continuación, se describe el personal clave y sus funciones:
          ...
          .col-lg-8.mb-3.mb-lg-0.order-lg-2.p-4
            SlyderF(columnas="col-12 col-lg-6")
              .bg-color-white.p-4.h-100.shadow-app
                h5.text-center.mb-4 Gerente de tienda 
                img.mb-(src='@/assets/curso/temas/tema7/4.png' alt='AvatarTop' , style="max-width: 252px").mx-auto.mb-3
                p.mb-0 Coordina el plan, aprueba presupuesto y evalúa resultados. 
              .bg-color-white.p-4.h-100.shadow-app
                h5.text-center.mb-4 Asesores de moda y belleza 
                img.mb-(src='@/assets/curso/temas/tema7/5.png' alt='AvatarTop' , style="max-width: 252px").mx-auto.mb-3
                p.mb-0 Ejecutan vitrinas, asesoran clientes y aplican técnicas de venta sensorial.
              .bg-color-white.p-4.h-100.shadow-app
                h5.text-center.mb-4 Diseñador gráfico 
              ...
              .bg-color-white.p-4.h-100.shadow-app
                h5.text-center.mb-4 Apoyo SENA 
                img.mb-(src='@/assets/curso/temas/tema7/8.png' alt='AvatarTop' , style="max-width: 252px").mx-auto.mb-3
                p.mb-0 Aplica conocimientos técnicos, apoya con fichas de seguimiento y prácticas.
    ...
    .row.justify-content-center.mb-5
      .col-xl-3.col-lg-7.col-md-9.col-11.mb-4.mb-xl-0
        .crd_hover_txt.tarjeta(data-aos="flip-left")
          .crd_hover_txt--img
            figure
              img(src="@/assets/curso/temas/tema7/9.png", alt="alt")
          .crd_hover_txt--body
            h4.mb-3.text-white.text-center VISUAL
            ul.lista-ul--color
              li.mb-0.d-flex
      ...
      .col-xl-3.col-lg-7.col-md-9.col-11.mb-4.mb-xl-0
        .crd_hover_txt.tarjeta(data-aos="flip-left")
          .crd_hover_txt--img
            figure
              img(src="@/assets/curso/temas/tema7/10.png", alt="alt")
          .crd_hover_txt--body
            h4.mb-3.text-white.text-center SENSORIAL 
            ul.lista-ul--color
              li.mb-0.d-flex
                i.fas.fa-check-circle.bg-color-9
                p.mb-0.text-white Iluminación focalizada en productos estrella.
              li.mb-0.d-flex
                i.fas.fa-check-circle.bg-color-9
                p.mb-0.text-white Aromatización suave con fragancias femeninas y modernas.
              li.mb-0.d-flex
                i.fas.fa-check-circle.bg-color-9
                p.mb-0.text-white Música ambiental con <em>playlists</em> relajantes y actualizadas.

      .col-xl-3.col-lg-7.col-md-9.col-11.mb-4.mb-xl-0
        .crd_hover_txt.tarjeta(data-aos="flip-left")
          .crd_hover_txt--img
            figure
              img(src="@/assets/curso/temas/tema7/11.png", alt="alt")
          .crd_hover_txt--body
            h4.mb-3.text-white.text-center PROMOCIONAL
            ul.lista-ul--color
              li.mb-0.d-flex
                i.fas.fa-check-circle.bg-color-9
                p.mb-0.text-white Combo "<em>Look</em> completo" (ropa + accesorio + perfume).
              li.mb-0.d-flex
                i.fas.fa-check-circle.bg-color-9
                p.mb-0.text-white Tarjeta de fidelización digital con QR y descuentos progresivos.
              li.mb-0.d-flex
                i.fas.fa-check-circle.bg-color-9
                p.mb-0.text-white Sorteos mensuales en redes sociales.
 
      .col-xl-3.col-lg-7.col-md-9.col-11.mb-4.mb-xl-0
        .crd_hover_txt.tarjeta(data-aos="flip-left")
          .crd_hover_txt--img
            figure
              img(src="@/assets/curso/temas/tema7/12.png", alt="alt")
          .crd_hover_txt--body
            h4.mb-3.text-white.text-center DIGITAL
            ul.lista-ul--color
              li.mb-0.d-flex
                i.fas.fa-check-circle.bg-color-9
